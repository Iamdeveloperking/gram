...
import com.popularapps.videodownloaderforinstagram.database.InstaImage;
import com.popularapps.videodownloaderforinstagram.service.DownloadService;
import com.popularapps.videodownloaderforinstagram.service.FileDownloaderService;
...
import static com.popularapps.videodownloaderforinstagram.service.FileDownloaderService.RESPONSE_DOWNLOAD_PROGRESS;
...
//                                                            String a = clipboard.getText().toString();
                                                            ...
                                                            {
                                                                CharSequence item = clip.getItemAt(0).coerceToText(getContext());
                                                                if (item != null) {
...
//					String id = url.replace("https://www.instagram.com/", "");
//					if(!id.isEmpty())
//						bandle.get(url);
//					else
...
//		});
//
//		Intent svc = new Intent(mContext, InstaClipBoard.class);
//		mContext.startService(svc);
//		ClipboardManager clipboard1 = (ClipboardManager) mContext.getSystemService(Context.CLIPBOARD_SERVICE);
//		assert clipboard1 != null;
//		if ((clipboard1.hasPrimaryClip()&& clipboard1.getPrimaryClipDescription().hasMimeType(MIMETYPE_TEXT_PLAIN))) {
//			ClipData data = clipboard1.getPrimaryClip();
//			assert data != null;
//			if (data.getItemCount() > 0)
//			{
//				CharSequence item = data.getItemAt(0).coerceToText(getContext());
//				if (item != null)
//				{
//
//					String paste = item.toString();
//
//					if(paste.matches("https://www.instagram.com/(.*)")) {
//						etURL.setText(item.toString());
//
//					}
//				}
//			}}
	...
	public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
		...
		AdView adView = mContext.findViewById(R.id.downloadads);

//.addTestDevice("88D4207EA8C91C8238E5C2C879724669")
		AdRequest adRequest1 = new AdRequest.Builder().build();
		adView.loadAd(adRequest1);

		AdView adView1 = mContext.findViewById(R.id.downloadads1);
	...
	class DownloadFileFromURL extends AsyncTask<String, String, String> {
		...
		@Override protected void onPostExecute(String file_url) {
			if (file_url != null) {
				...
				Toast.makeText(getActivity(), "Post Already downloaded", Toast.LENGTH_LONG).show();
			}
